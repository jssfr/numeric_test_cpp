...
hidden if the `c_numeric_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `c_numeric_DEVELOPER_MODE` to the configure
...
Runs the executable target `c_numeric_exe`.
